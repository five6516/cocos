...
cc.Class({
    ...
    _Init:function(){
        this.node.getComponent(cc.Sprite).spriteFrame = this.birdPic;
        ...
        this._call = function () {
            ...
            if (Globals.GameState == false || Globals.Bang == true) {
                this._PlayBang();    
            }
        };
    ...
    _DestoryBird:function(){
        gfunction.birdPool.put(this.node);//释放节点
    },
